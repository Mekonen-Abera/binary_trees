...
/**
 * swap - A function that swaps two nodes in binary tree
 * @a: a first node
 * @b: a second node
...
/**
 * binary_tree_size - A funtion measures the size of a binary tree
 * @tree: an input binary tree
 *
...
/**
 * insert - helper function to be inserted to exact node
 * @root: a double pointer to root of max heap
 * @node: a node to inserted
 *
 * Return: Nothing
 */
...
/**
 * heap_insert - A funtion that inserts a value in Max Binary Heap

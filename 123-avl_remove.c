...
/**
 * balance_left - A function that balances left side
 * @node: A pointer to temporary node
...
/**
 * rebalance - A function that rebalance AVL tree
 * @node: a pointer to node to rebalance
 * @tree: a double pointer to root of tree
 *
 * Return: a pointer to input node
 */
...
/**
 * bst_search - A function that searches for a value in a Binary trees
...
/**
 * replace - A function that swaps two nodes in binary tree
 * @node: a first node
 * @new: a second node

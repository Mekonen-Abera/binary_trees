...
/**
 * swap_head - A function that helps to swap head and node
 * @head: a pointer to head
 * @node: a pointer to node
 *
 * Return: The pointer to severed head of tree
 */
...
/**
 * perc_down - A function that percolate head into correct position
 * @node: a pointer to head
 *
 * Return: The pointer to head of tree
 */

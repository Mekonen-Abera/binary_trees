...
/**
 * inorder_successor - Returns the minimum value of a binary tree.
 ...
 * @root: A pointer to the root node of the BST to be removed
...
/**
 * bst_remove - Removes a node from a binary trees

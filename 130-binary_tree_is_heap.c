...
/**
 * binary_tree_size - A funtion that measures the size of a binary tree
...
/**
 * is_complete - The helper function for binary_tree_is_complete
 * @tree: a pointer to root of tree
 * @index: an index of current node to be verified
...
/**
 * binary_tree_is_complete - A function checks if a binary tree is complete
 * @tree: a pointer to root of tree
 *
 * Return: 1 if true
 *       : 0 if false
